...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _profileInfo.addCoachesMoreInfoClass)();
...
},{"./iframe-video":1,"./modules/form-validate/form":4,"./profile-info":10,"./utils/ios-vh-fix":12}],3:[function(require,module,exports){
"use strict";
...
exports.addCoachesMoreInfoClass = void 0;
var addCoachesMoreInfoClass = function addCoachesMoreInfoClass() {
  var coachesSlider = document.querySelector('.coaches__swiper');
  if (coachesSlider) {
    var coachesProfiles = document.querySelectorAll('.coaches__profile');
    var isMobile = window.matchMedia('(max-width: 1200px)').matches;
    if (isMobile) {
      coachesSlider.addEventListener('click', function (event) {
        var target = event.target.closest('.coaches__profile');
        if (target) {
          var moreInfo = target.querySelector('.coaches__more-info');
          var name = target.querySelector('.coaches__name');
          if (moreInfo) {
      ...
      coachesProfiles.forEach(function (profile) {
        profile.addEventListener('mouseenter', function () {
          var moreInfo = profile.querySelector('.coaches__more-info');
          var name = profile.querySelector('.coaches__name');
          if (moreInfo) {
            moreInfo.classList.add('coaches__more-info--visible');
            name.classList.add('coaches__name--hidden');
          }
...
exports.addCoachesMoreInfoClass = addCoachesMoreInfoClass;
